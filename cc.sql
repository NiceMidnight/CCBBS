...
CREATE TABLE `apply_recruiter`  (
  `apply_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '申请应聘人员权限id',
  ...
  `handling_user_id` bigint(20) NULL DEFAULT NULL COMMENT '处理用户',
  `handling_at` datetime(6) NULL DEFAULT NULL COMMENT '处理时间',
  `truth_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '真实姓名',
  `student_id` int(13) NOT NULL COMMENT '学号',
...
CREATE TABLE `article`  (
  ...
  `article_content` text CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT '文章内容',
  ...
  `article_status` varchar(7) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT 'PUBLIC' COMMENT '可见/不可见',
...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '评论' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `feedback`  (
  ...
  `feedback_type` int(11) NULL DEFAULT NULL COMMENT '反馈类型',
  `feedback_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '反馈内容',
  `creator_id` bigint(11) NULL DEFAULT NULL COMMENT '提交的用户的id',
  `create_time` datetime(6) NULL DEFAULT NULL COMMENT '创建时间',
  `handler_id` bigint(11) NULL DEFAULT NULL COMMENT '处理的管理员的id',
...
-- Records of follow
-- ----------------------------
INSERT INTO `follow` VALUES (2, 1, '2024-02-28 22:55:02', 'Follow');
INSERT INTO `follow` VALUES (2, 2, '2024-03-05 15:10:19', 'Unfollowed');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '云端图片' ROW_FORMAT = Dynamic;
...
CREATE TABLE `job`  (
  `job_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '招聘id',
  `topic_id` int(11) NOT NULL COMMENT '主题',
  `job_title` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '工作标题',
  `job_content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '工作内容',
  ...
  `view_count` int(255) NOT NULL DEFAULT 0 COMMENT '点击数',
...
INSERT INTO `post` VALUES (2, 2, '失物手表', '测试啊2', 1, '2023-11-24 10:22:54.000000', 'COMPLIANCE', 'PUBLIC', 69, 1, 0, 0);
INSERT INTO `post` VALUES (3, 1, '测试提交', '<h1>查看提交</h1><p style=\"text-align: left;\">1231231231<img src=\"https://postfiles.oss-cn-guangzhou.aliyuncs.com/mmexport1639369490349.jpg\" alt=\"\" data-href=\"\" style=\"width: 30%;\"></p>', 2, '2024-02-16 14:51:58.222000', 'COMPLIANCE', 'PUBLIC', 25, 0, 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 63 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '令牌' ROW_FORMAT = Dynamic;
...
INSERT INTO `token` VALUES (50, 1, 'root', '0d2086c0-8ecd-42f4-a7d4-6620d2d80dcc', '{\"id\":1,\"userHead\":null,\"userName\":\"root\",\"nickName\":\"管理员\",\"password\":null,\"userSex\":null,\"userAge\":null,\"userPhone\":null,\"userAddress\":null,\"userDate\":null,\"userRole\":1,\"userStatus\":\"ENABLE\",\"userDeleted\":1,\"userVersion\":0,\"userPersonality\":null,\"fans\":0}', 'EFFECTIVE');
...
INSERT INTO `token` VALUES (60, 1, 'root', '5509b4a5-6bac-41bc-bd28-069e0bbffd77', '{\"id\":1,\"userHead\":null,\"userName\":\"root\",\"nickName\":\"管理员\",\"password\":null,\"userSex\":null,\"userAge\":null,\"userPhone\":null,\"userAddress\":null,\"userDate\":null,\"userRole\":1,\"userStatus\":\"ENABLE\",\"userDeleted\":1,\"userVersion\":1,\"userPersonality\":null,\"fans\":0}', 'EFFECTIVE');
...
CREATE TABLE `topic_for_job`  (
  `topic_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '招聘主题',
...
-- ----------------------------
INSERT INTO `topic_for_job` VALUES (1, '长期');
INSERT INTO `topic_for_job` VALUES (2, '短期');
INSERT INTO `topic_for_job` VALUES (3, '兼职');
...
CREATE TABLE `user`  (
  ...
  `user_personality` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '个性签名',
...
INSERT INTO `user` VALUES (2, 'static/sys_img/adminHead/2023.jpg', 'zhangsan', '小宜', 'zhangsan', 1, 20, '16616649103', '广西省桂林市', '123随便', '2024-02-14 15:26:18.207000', 0, 'ENABLE', 1, 0, 1);
