...
INSERT INTO `comments` VALUES (47, 1, 2, 'a ', NULL, '2024-04-12 12:27:50.632000', 'Read', 'COMPLIANCE');
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '每日用户单个访问记录' ROW_FORMAT = Dynamic;
...
INSERT INTO `daily_unique_visitors` VALUES (20, 2, '2024-04-26 12:23:47.832000', '0:0:0:0:0:0:0:1');
INSERT INTO `daily_unique_visitors` VALUES (21, 2, '2024-05-06 15:25:28.676000', '0:0:0:0:0:0:0:1');
...
INSERT INTO `dislikes_for_post` VALUES (2, 3, 'Undisliked', '2024-05-06 16:16:34.214000');
...
CREATE TABLE `favorite_for_post`  (
  ...
  `favorite_status` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'Favorite' COMMENT '是否收藏Favorite/Unfavorite',
  `favorite_post_status` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'PUBLIC' COMMENT '帖子的所有状态（COMPLIANCE/IRREGULARITY）（PUBLIC/PRIVATE）',
...
-- ----------------------------
INSERT INTO `favorite_for_post` VALUES (1, 2, 3, NULL, '2024-04-09 11:54:06.540000', 'Favorite', 'PUBLIC');
...
INSERT INTO `likes_for_post` VALUES (2, 3, 'Liked', '2024-05-06 16:16:35.456000');
...
INSERT INTO `post` VALUES (3, 1, '测试提交', '<h1>查看提交</h1><p style=\"text-align: left;\">1231231231<img src=\"https://postfiles.oss-cn-guangzhou.aliyuncs.com/mmexport1639369490349.jpg\" alt=\"\" data-href=\"\" style=\"width: 30%;\"></p>', 2, '2024-03-18 14:51:58.000000', 'COMPLIANCE', 'PUBLIC', 51, 1, 1, 0, 1);
...
INSERT INTO `post` VALUES (12, 1, '123', '<p>123</p>', 2, '2024-04-12 12:20:46.632000', 'IRREGULARITY', 'PUBLIC', 0, 0, 0, 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 105 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '令牌' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `token` VALUES (102, 2, 'zhangsan', '6f872d1a-46cc-4a3a-a3af-414355cbf398', '{\"id\":2,\"userHead\":\"https://postfiles.oss-cn-guangzhou.aliyuncs.com/8f80f8f9-46f3-4a4c-843d-a12cd12b5cc0_getThumbnail.jpg\",\"userName\":\"zhangsan\",\"nickName\":\"小宜\",\"password\":null,\"userSex\":1,\"userPhone\":\"16616649123\",\"userAddress\":\"江西、景德镇市\",\"userDate\":1707895578207,\"userRole\":2,\"dictItemName\":null,\"dictColor\":null,\"userStatus\":\"ENABLE\",\"userDeleted\":1,\"userVersion\":0,\"userPersonality\":\"123随便\",\"fans\":2}', 'INVALID');
INSERT INTO `token` VALUES (103, 1, 'root', '67bb8293-ee40-4122-84fc-25eaa63d5cfb', '{\"id\":1,\"userHead\":null,\"userName\":\"root\",\"nickName\":\"管理员\",\"password\":null,\"userSex\":null,\"userPhone\":null,\"userAddress\":null,\"userDate\":null,\"userRole\":1,\"dictItemName\":null,\"dictColor\":null,\"userStatus\":\"ENABLE\",\"userDeleted\":1,\"userVersion\":0,\"userPersonality\":null,\"fans\":0}', 'EFFECTIVE');
INSERT INTO `token` VALUES (104, 2, 'zhangsan', '327fda7b-5413-4f90-86ef-d0ad573bfb68', '{\"id\":2,\"userHead\":\"https://postfiles.oss-cn-guangzhou.aliyuncs.com/8f80f8f9-46f3-4a4c-843d-a12cd12b5cc0_getThumbnail.jpg\",\"userName\":\"zhangsan\",\"nickName\":\"小宜\",\"password\":null,\"userSex\":1,\"userPhone\":\"16616649123\",\"userAddress\":\"江西、景德镇市\",\"userDate\":1707895578207,\"userRole\":2,\"dictItemName\":null,\"dictColor\":null,\"userStatus\":\"ENABLE\",\"userDeleted\":1,\"userVersion\":0,\"userPersonality\":\"123随便\",\"fans\":2}', 'INVALID');
INSERT INTO `token` VALUES (105, 2, 'zhangsan', 'd01d78ed-e7bc-4c03-9a9a-cd652c1c4641', '{\"id\":2,\"userHead\":\"https://postfiles.oss-cn-guangzhou.aliyuncs.com/8f80f8f9-46f3-4a4c-843d-a12cd12b5cc0_getThumbnail.jpg\",\"userName\":\"zhangsan\",\"nickName\":\"小宜\",\"password\":null,\"userSex\":1,\"userPhone\":\"16616649123\",\"userAddress\":\"江西、景德镇市\",\"userDate\":1707895578207,\"userRole\":2,\"dictItemName\":null,\"dictColor\":null,\"userStatus\":\"ENABLE\",\"userDeleted\":1,\"userVersion\":1,\"userPersonality\":\"123随便\",\"fans\":2}', 'EFFECTIVE');
